...
const addTask = () => {
    ...
    submit.addEventListener("click", () => {
        ...
        if (pickColor != "" && pickedCategories.length > 0 && deadline.value != "" && location.value != "") {
            ...
            const taskItem = {
                id: tasks!= null ? tasks.length + 1 : 1,//line
                title: title.value,
            ...
            if(existingTasks != null)  localStorage.setItem("tasks", JSON.stringify([...existingTasks,taskItem]))//line
            else  localStorage.setItem("tasks", JSON.stringify([taskItem]))
